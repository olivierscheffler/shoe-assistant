/**
 * Domaine métier de l'assistant chaussures : questionnaire, catalogue de lignes de
 * modèles réellement commercialisées, et moteur de correspondance déterministe.
 *
...
export interface ShoeModel {
  ...
  wideFit: boolean;
  waterproof: "aucune" | "traitement" | "membrane";
...
export const QUESTIONS: Record<QuestionId, Question> = {
  usage: {
    ...
    help: "Ce que vous ferez avec la paire la plupart du temps.",
    options: [
      ...
      { value: "lifestyle", label: "Surtout le style", hint: "Sneakers portées au quotidien" },
    ],
  },
  terrain: {
    id: "terrain",
    label: "Terrain le plus fréquent",
    options: [
      ...
      { value: "mixte", label: "Un peu des trois" },
    ],
  },
  volume: {
    id: "volume",
  ...
  appui: {
    ...
    help: "En cas de doute, répondez « je ne sais pas » : nous vous dirons quoi vérifier.",
    options: [
  ...
  pied: {
    ...
    help: "Plusieurs choix possibles, ou aucun.",
    multiple: true,
    options: [
  ...
  exigences: {
    ...
    help: "Plusieurs choix possibles. Ce sont des contraintes fortes dans le calcul.",
    multiple: true,
    options: [
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    intro:
      "Budget et exigences servent de filtres durs : un modèle qui ne les respecte pas sera écarté, et nous vous dirons pourquoi.",
    questions: ["budget", "exigences"],
  },
  {
    id: "style",
...
export const CATALOG: ShoeModel[] = [
  ...
  },
  {
    ...
    caveats: ["Durabilité moyenne si vous marchez beaucoup sur gravier"],
  },
  {
    id: "hoka-gaviota",
    brand: "HOKA",
